...
router.use('/heroSlides', createCrudRouter(prisma.heroSlide, 'heroSlides', undefined, { cacheKeys: ['hero_slides'] }));
router.use('/hotels', createCrudRouter(prisma.hotel, 'hotels', undefined, { cacheKeys: ['hotels'] }));
...
router.use('/tours', createCrudRouter(prisma.tour, 'tours', undefined, { cacheKeys: ['tours'] }));
