...
export function PaymentPage() {
 ...
 <div>
 <div className="font-bold">Ví LunaTravel Business Pay</div>
 ...
 <p className="text-xs text-orange-800">Bạn vui lòng đến quầy vé LunaTravel Business tại bến xe để thanh toán bằng tiền mặt và nhận vé cứng trong vòng 30 phút kể từ lúc đặt thành công. Sau thời gian này, vé sẽ tự động bị hủy.</p>
 </div>
 </div>
 </motion.div>
 )}
 ...
 <span>Bằng việc bấm Thanh toán, bạn đồng ý với Điều khoản sử dụng và Chính sách bảo mật của LunaTravel Business.</span>
 </div>
 </Card>
 </div>
