...
// Cùng ngôn ngữ thiết kế cinematic của AuthPage.tsx (serif Cormorant, nút
// CTA đen, blob mờ, card kính mờ) — bản sắc thương hiệu An Chuyến.
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="min-h-screen bg-background flex items-center justify-center px-4 py-10 relative overflow-hidden">
      ...
      >
        ...
        {error && <div className="bg-red-50 border border-red-100 rounded-xl p-4 text-sm text-red-500 text-center mb-4">{error}</div>}

        {bankInfo && (
          <>
            <div className="flex justify-center mb-6">
              <img src={qrUrl} alt="Mã QR chuyển khoản" className="w-56 h-56 rounded-2xl border border-gray-100" />
            </div>
