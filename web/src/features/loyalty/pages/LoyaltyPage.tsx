...
export function LoyaltyPage() {
 ...
 <div>
 <h1 className="text-3xl font-black text-gray-900 mb-2">Thành viên LunaTravel Business</h1>
 ...
 <p className="text-xs text-gray-400">Thẻ điện tử này được phát hành bởi LunaTravel Business. Hotline: 1900 1234</p>
 </div>
 </motion.div>
 </div>
