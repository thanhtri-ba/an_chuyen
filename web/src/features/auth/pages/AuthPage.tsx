          ...
          >
            <AnimatePresence mode="wait">
              <motion.div key={isLogin ? 'login' : 'register'}
                ...
                {/* Google — OAuth chưa được cấu hình (thiếu Google Client ID/Secret),
                    nên báo trạng thái rõ ràng thay vì một nút bấm không phản hồi gì. */}
                <button type="button" onClick={() => toast.info('Đăng nhập Google sẽ sớm ra mắt. Vui lòng dùng email/mật khẩu.')}
