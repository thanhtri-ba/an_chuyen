...
export function DeliveryPage() {
 ...
 <h3 className="text-gray-900 font-bold mb-4">1. Package Type</h3>
 ...
 <h3 className="text-gray-900 font-bold">2. Locations</h3>
 {isGeocoding && <Loader2 className="w-4 h-4 text-primary animate-spin" />}
 </div>
 
 <div className="relative">
 <div className="absolute left-[15px] top-[24px] bottom-[24px] w-0.5 bg-slate-200"></div>
 
 <div className="flex items-center gap-4 mb-4 relative">
 <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center z-10 shrink-0 shadow-md">
 <MapPin className="w-4 h-4 text-white" />
 </div>
 <input type="text" value={pickup} onChange={e => setPickup(e.target.value)} placeholder="Nhập điểm lấy hàng..." className="w-full bg-gray-50 px-4 py-3 text-sm font-medium text-slate-700 outline-none focus:ring-2 focus:ring-primary/20 transition-all border border-transparent focus:border-primary/30" />
 </div>
 
 <div className="flex items-center gap-4 relative">
 <div className="w-8 h-8 rounded-full bg-white border-4 border-primary z-10 shrink-0 shadow-sm"></div>
 <input type="text" value={dropoff} onChange={e => setDropoff(e.target.value)} placeholder="Nhập điểm giao hàng..." className="w-full bg-gray-50 px-4 py-3 text-sm font-medium text-slate-700 outline-none focus:ring-2 focus:ring-primary/20 transition-all border border-transparent focus:border-primary/30" />
 </div>
 </div>
 </div>
 ...
 {/* Select Vehicle */}
 <div className="bg-white border border-gray-100 p-6 shadow-sm">
 <h3 className="text-gray-900 font-bold mb-4">3. Select Vehicle</h3>
 {loading ? (
 ...
 >
 <div className={`w-12 h-12 flex items-center justify-center mr-4 ${selectedVehicle === v.id ?'bg-primary text-primary-foreground' :'bg-slate-100 text-slate-600'}`}>
 ...
 {/* Map Area */}
 <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.2 }} className="bg-white border border-gray-100 p-4 shadow-sm flex-1 relative overflow-hidden flex flex-col min-h-[500px]">
 
 <div className="flex justify-between items-center gap-4 mb-4 z-10 relative">
 <div className="bg-white shadow-lg shadow-slate-200/50 rounded-full px-5 py-2.5 flex items-center gap-2 text-sm font-bold text-slate-700">
 ...
 {isSuccess && (
 <div className="mt-auto relative z-10 bg-white/95 backdrop-blur-md p-4 shadow-xl border border-white/50 m-2">
 <div className="flex justify-between items-start mb-4">
 <div>
 <h4 className="font-bold text-slate-800 text-sm">Giao đến</h4>
 <p className="text-xs text-slate-500 line-clamp-1">{dropoff}</p>
 </div>
 ...
 <div className="flex-1">
 <p className="text-xs font-bold text-slate-800">Đang tìm tài xế... <span className="text-slate-400 font-normal">--</span></p>
 </div>
 </div>
 ...
 className="bg-white border border-gray-100 p-6 shadow-sm flex items-center justify-between"
 >
 <div>
 <p className="text-sm font-medium text-slate-500 mb-1">Total Estimated Cost</p>
