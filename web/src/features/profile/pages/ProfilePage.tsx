...
export function ProfilePage() {
 ...
 <div>
 <div className="text-white/70 text-xs font-bold uppercase tracking-widest mb-1">LunaTravel Business Member Card</div>
 ...
 <span className="text-white/70">{t('profile.currentPoints')}</span>
 ...
 <div>
 <div className="text-white/60 text-xs">{t('profile.accumulatedPoints')}</div>
 ...
 <div>
 <h3 className="font-extrabold text-gray-900">{t('profile.walletTitle')}</h3>
 <div className="text-xs text-gray-400">{t('profile.availableBalance')}</div>
 </div>
 </div>
 ...
 <Button size="sm" className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold h-10">{t('profile.deposit')}</Button>
 <Button size="sm" variant="outline" className="border-indigo-200 text-indigo-600 font-bold h-10 hover:bg-indigo-50">{t('profile.history')}</Button>
 </div>
 </Card>
 </motion.div>
 ...
 {[
 { icon: Ticket, label:t('profile.myTickets'), sub:t('profile.myTicketsSub'), href:'/my-bookings', color:'text-primary', bg:'bg-slate-100' },
 { icon: Award, label:t('profile.loyaltyProgram'), sub:t('profile.loyaltyProgramSub'), href:'#', color:'text-yellow-600', bg:'bg-yellow-50' },
 { icon: Shield, label:t('profile.security'), sub:t('profile.securitySub'), href:'#', color:'text-emerald-600', bg:'bg-emerald-50' },
 { icon: Bell, label:t('profile.notifications'), sub:t('profile.notificationsSub'), href:'/notifications', color:'text-purple-600', bg:'bg-purple-50' },
 ].map((item, i) => (
 ...
 <label className="text-xs font-extrabold text-gray-500 uppercase tracking-wider">{t('profile.fullName')}</label>
 ...
 <div className="space-y-2">
 <label className="text-xs font-extrabold text-gray-500 uppercase tracking-wider">{t('profile.phone')}</label>
 <div className="relative">
 ...
 <div className="space-y-2">
 <label className="text-xs font-extrabold text-gray-500 uppercase tracking-wider">{t('profile.emailLabel')}</label>
 <div className="relative">
 ...
 <div className="space-y-2">
    <label className="text-xs font-extrabold text-gray-500 uppercase tracking-wider">{t('profile.gender')}</label>
  ...
  <div className="space-y-2">
    <label className="text-xs font-extrabold text-gray-500 uppercase tracking-wider">{t('profile.dob')}</label>
    <div className="relative">
      <Input 
        type="date" 
        value={dob} 
  ...
  <div className="space-y-2">
    <label className="text-xs font-extrabold text-gray-500 uppercase tracking-wider">{t('profile.emergencyPhone')}</label>
    <div className="relative">
      <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
      <Input 
        type="text" 
  ...
  <div className="space-y-2">
    <label className="text-xs font-extrabold text-gray-500 uppercase tracking-wider">{t('profile.nationality')}</label>
    <div className="relative">
      <Input 
        type="text" 
        value={nationality} 
  ...
  <div className="space-y-2">
    <label className="text-xs font-extrabold text-gray-500 uppercase tracking-wider">{t('profile.occupation')}</label>
    <div className="relative">
      <Input 
        type="text" 
        value={occupation} 
  ...
  <div className="space-y-2">
    <label className="text-xs font-extrabold text-gray-500 uppercase tracking-wider">{t('profile.address')}</label>
    <div className="relative">
      <textarea
        value={address}
 ...
 <p className="text-sm text-gray-400 font-medium mb-6">{t('profile.earnMorePointsPrefix')} <strong className="text-gray-700">{(tier.pointsNeeded - tier.currentPoints).toLocaleString()}</strong> {t('profile.earnMorePointsSuffix')} Gold {t('profile.earnMorePointsEnd')}</p>
 ...
 {[
 { label:t('profile.totalTrips'), value: bookingsCount.toString(), icon:'🚌', color:'text-primary' },
 { label:t('profile.accumulatedPoints'), value: currentPoints.toLocaleString(), icon:'⭐', color:'text-yellow-600' },
 { label:t('profile.totalKm'), value:'0 km', icon:'📍', color:'text-emerald-600' },
 { label:t('profile.totalSaved'), value:'0đ', icon:'💰', color:'text-secondary' },
 ].map((stat, i) => (
