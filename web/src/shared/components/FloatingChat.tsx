...
export function FloatingChat() {
 ...
 className="relative group bg-primary hover:bg-primary-hover text-primary-foreground p-4 rounded-full shadow-lg shadow-primary/40 transition-colors flex items-center justify-center"
 >
